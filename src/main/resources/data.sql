...
INSERT INTO QUESTIONS(id, questionBody, questionType, surveyId)
	VALUES
    (1, "questionBodyA1", 1, 1), (2, "questionBodyA2", 1, 1), (3, "questionBodyA3", 2, 1), (4, "questionBodyA4", 3, 1), (17, "questionOpenA5", 0, 1),
...
INSERT INTO QUESTION_POSSIBLEANSWER(possibleAnswerA, possibleAnswerB, possibleAnswerC, possibleAnswerD, QuestionId)
	VALUES
    ("Aaa", "Bbb", "Ccc", "Ddd", 1), ("A", "B", "C", "D", 2), ("A", "B", "C", "D", 3),
...
INSERT INTO ANSWEREDSURVEYS(Id, date, age, country, surveyId)
    VALUES
      (1, curdate(), 15, 'PL', 1),
      (2, curdate(), 12, 'PL',  2),
      (3, curdate(), 13, 'PL',  3),
